...
<div class="max-w-md mx-auto bg-white p-6 rounded-xl shadow-md mt-12">
    <h2 class="text-2xl font-bold mb-4 text-gray-800 text-center">Register Now</h2>
    ...
    <form method="POST" action="/register" class="space-y-4">
        ...
        <div>
            ...
            <input type="email" id="email" name="email" required
                   class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-0.5 focus:ring-black focus:border-black"/>
        </div>
